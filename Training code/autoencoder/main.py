...
#fault_folder = '/Blur/'
#fault_folder = '/Rain/'  # also Rain or SpeckleNoise
fault_folder = '/SpeckleNoise/'
intensity_folder = '/e/'  # e as extreme also m as medium or l as low
# specify the csv file name
#csv_file = 'Blur_m_label.csv'
#csv_file = 'Blur_m_label.csv'
csv_file = 'SpeckleNoise_e_label.csv'
#csv_file = 'Rain_l_label.csv'
Batch_size = 12
EPOCHS = 250
...
if __name__ == '__main__':
    ...
    # train_loader,valid_loader,test_loader = data_loaders(data, batch_size=Batch_size, test_size = 0.2, valid_size = 0.1, if_validation = True, num_workers=0)
    # train_loader,valid_loader,test_loader = data_loaders(data)
