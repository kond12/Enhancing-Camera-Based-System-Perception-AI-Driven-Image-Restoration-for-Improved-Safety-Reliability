...
model_paths = [
    'C:/low/anoise/model_0.pth',
    'C:/low/anoise/model_1.pth',
    'C:/low/anoise/model_2.pth',
    'C:/low/anoise/model_3.pth',
    'C:/low/anoise/model_4.pth',
    'C:/low/anoise/model_5.pth',
    'C:/low/anoise/model_8.pth',
    'C:/low/anoise/model_12.pth',
    'C:/low/anoise/model_20.pth',
    'C:/low/anoise/model_47.pth',
    'C:/low/anoise/model_83.pth',
    'C:/low/anoise/model_103.pth',
    'C:/low/anoise/model_117.pth',
    'C:/low/anoise/model_132.pth',
    'C:/low/anoise/model_204.pth',
...
# Output directory
output_dir = 'test_output_images-anl-new'
...
for model_path in model_paths:
    ...
    clear_image = Image.open(image_path1).convert("RGB")
...
# Use torchvision normalization
      denoised_image = transforms.ToPILImage()(output.squeeze())
    ...
    #out_norm = normalize(output[0])  # Assuming batch size is 1
